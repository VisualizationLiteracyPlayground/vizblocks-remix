...
import { barChartPreQuestion1, barChartPreQuestion2 } from '~/constants'
  ...
  return (
    <div style={{ padding: 16 }}>
      ...
      >
        ...
        <Box sx={{ pl: 8 }}>
          <VlatQuiz questionNum={1} question={barChartPreQuestion1} onUpdate={handleUpdate} />
          <VlatQuiz questionNum={2} question={barChartPreQuestion2} onUpdate={handleUpdate} />
        </Box>
